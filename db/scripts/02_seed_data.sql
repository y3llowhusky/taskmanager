...
INSERT INTO usuarios (nome, email, senha, telefone, data_nascimento, data_cadastro, status, tipo)
...
INSERT INTO tarefas (nome, descricao, data_criacao, situacao, criador_id, responsavel_id, prazo_entrega)
